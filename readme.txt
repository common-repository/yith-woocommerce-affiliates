...
You can report security bugs through the Patchstack Vulnerability Disclosure Program. The Patchstack team help validate, triage and handle any security vulnerabilities. [Report a security vulnerability.](https://patchstack.com/database/vdp/yith-woocommerce-affiliates)
...
= 3.11.0 - Released on 7 October 2024 =

* New: support for WooCommerce 9.3
* Update: YITH plugin framework

= 3.10.0 - Released on 8 August 2024 =

* New: support for WooCommerce 9.2
* Update: YITH plugin framework

= 3.9.0 - Released on 8 July 2024 =

* New: support for WordPress 6.6
* New: support for WooCommerce 9.1
* Update: YITH plugin framework

= 3.8.1 - Released on 1 July 2024 =

* Fix: removed polyfill.io references

= 3.8.0 - Released on 24 June 2024 =

* New: support for WooCommerce 9.0
* Update: YITH plugin framework
* Fix: possible type warnings with PHP 8.2
* Dev: moved table definitions to DataStores classes

= 3.7.0 - Released on 14 May 2024 =

* New: support for WooCommerce 8.9
* Update: YITH plugin framework

= 3.6.0 - Released on 8 April 2024 =

* New: support for WooCommerce 8.8
* Update: YITH plugin framework
* Fix: improved conditions checked before setting session cookie
