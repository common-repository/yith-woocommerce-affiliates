...
var YITH_WCAF_Admin_Tabs = /*#__PURE__*/function () {
  ...
  return _createClass(YITH_WCAF_Admin_Tabs, [{
    key: "initTabs",
...
var YITH_WCAF_Admin_Tabbed_Modal = /*#__PURE__*/function (_YITH_WCAF_Admin_Moda) {
  function YITH_WCAF_Admin_Tabbed_Modal($opener, args) {
    ...
    _this = _callSuper(this, YITH_WCAF_Admin_Tabbed_Modal, [$opener, yith_wcaf_admin_tabbed_modal_objectSpread({
      classes: {
        wrap: 'yith-wcaf-modal',
    ...
    // tabs
    _defineProperty(_this, "$tabs", null);
    return _this;
  }
  _inherits(YITH_WCAF_Admin_Tabbed_Modal, _YITH_WCAF_Admin_Moda);
  return _createClass(YITH_WCAF_Admin_Tabbed_Modal, [{
    key: "onOpen",
    value: function onOpen() {
...
function yith_wcaf_add_affiliate_modal_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, yith_wcaf_add_affiliate_modal_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function yith_wcaf_add_affiliate_modal_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (yith_wcaf_add_affiliate_modal_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
...
var YITH_WCAF_Add_Affiliate_Modal = /*#__PURE__*/function (_YITH_WCAF_Admin_Tabb) {
  function YITH_WCAF_Add_Affiliate_Modal($opener) {
    ...
    return yith_wcaf_add_affiliate_modal_callSuper(this, YITH_WCAF_Add_Affiliate_Modal, [$opener, {
  ...
  return _createClass(YITH_WCAF_Add_Affiliate_Modal, [{
    key: "initPswForm",
...
function yith_wcaf_admin_info_modal_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, yith_wcaf_admin_info_modal_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function yith_wcaf_admin_info_modal_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (yith_wcaf_admin_info_modal_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
...
var YITH_WCAF_Admin_Info_Modal = /*#__PURE__*/function (_YITH_WCAF_Admin_Moda) {
  function YITH_WCAF_Admin_Info_Modal() {
    ...
    return yith_wcaf_admin_info_modal_callSuper(this, YITH_WCAF_Admin_Info_Modal, arguments);
  }
  _inherits(YITH_WCAF_Admin_Info_Modal, _YITH_WCAF_Admin_Moda);
  return _createClass(YITH_WCAF_Admin_Info_Modal, [{
    key: "onSubmit",
...
var YITH_WCAF_Admin_Panel = /*#__PURE__*/function () {
  ...
  return _createClass(YITH_WCAF_Admin_Panel, [{
    key: "initFields",
    value: function initFields() {
...
function affiliates_callSuper(t, o, e) { return o = _getPrototypeOf(o), _possibleConstructorReturn(t, affiliates_isNativeReflectConstruct() ? Reflect.construct(o, e || [], _getPrototypeOf(t).constructor) : o.apply(t, e)); }
function affiliates_isNativeReflectConstruct() { try { var t = !Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {})); } catch (t) {} return (affiliates_isNativeReflectConstruct = function _isNativeReflectConstruct() { return !!t; })(); }
...
var YITH_WCAF_Affiliates = /*#__PURE__*/function (_YITH_WCAF_Admin_Pane) {
  function YITH_WCAF_Affiliates() {
    ...
    _this = affiliates_callSuper(this, YITH_WCAF_Affiliates, [$containers]);
  ...
  return _createClass(YITH_WCAF_Affiliates, [{
    key: "initConfirm",
